...
class RegistryDocument(Base):
    ...
    product_brand: Mapped[str | None] = mapped_column(String(255))
    product_model: Mapped[str | None] = mapped_column(String(255))
    product_article: Mapped[str | None] = mapped_column(String(255))
    ...
    test_protocol_number: Mapped[str | None] = mapped_column(String(255))
